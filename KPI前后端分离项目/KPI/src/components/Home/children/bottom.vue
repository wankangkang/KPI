<template>
	<section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/home'})" class="guide_item">
            ...
            <icon class="icon_style" :name="$route.path.indexOf('home') == -1? 'home' : 'homeActive'" ></icon>
            <span>首页</span>
        </section>
        <section @click = "gotoAddress({path: '/kpi'})" class="guide_item">
        	<icon class="icon_style" :name="$route.path.indexOf('kpi') == -1? 'kpi' : 'kpiActive'" ></icon>
        	<span>KPI</span>
        </section>
        <section @click = "gotoAddress({path: '/advise'})" class="guide_item">
        	<icon class="icon_style" :name="$route.path.indexOf('advise') == -1? 'message' : 'messageActive'" ></icon>
        	<span>发布</span>
        </section>
        <section @click = "gotoAddress({path: '/personHome'})" class="guide_item">
        	<icon class="icon_style" :name="$route.path.indexOf('personHome') == -1? 'user' : 'userActive'" ></icon>
        	<span>我</span>
        </section>
    </section>
